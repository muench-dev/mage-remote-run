...
export async function updateCompanyAction(companyId) {
    try {
        const client = await createClient();
        const { default: inquirer } = await import('inquirer');
...
export async function deleteCompanyAction(companyId, options) {
    try {
        const client = await createClient();
        const { default: inquirer } = await import('inquirer');
...
export async function structureCompanyAction(companyId) {
    try {
        const client = await createClient();
...
export async function showRoleAction(roleId) {
    try {
        const client = await createClient();
...
export async function showCreditAction(companyId) {
    try {
        const client = await createClient();
...
export async function historyCreditAction(companyId, options) {
    try {
        const client = await createClient();
...
export async function increaseCreditAction(creditId, amount, options) {
    try {
        const client = await createClient();
...
export async function decreaseCreditAction(creditId, amount, options) {
    try {
        const client = await createClient();
        const inquirer = (await import('inquirer')).default;
        const { select } = await import('@inquirer/prompts');
