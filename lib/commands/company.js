...
import { COMPANY_CREATE_QUESTIONS, ADDRESS_QUESTIONS, getCompanyUpdateQuestions } from '../prompts/company.js';
...
`)
        .action(async () => {
            try {
                ...
                const address = await inquirer.prompt(ADDRESS_QUESTIONS);
