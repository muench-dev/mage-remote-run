...
import { printTable, handleError, buildSearchCriteria, buildSortCriteria, buildPaginationCriteria } from '../utils.js';
...
async function showOrder(identifier, format = 'text') {
    ...
    const headers = {};
    if (format === 'json') headers.Accept = 'application/json';
